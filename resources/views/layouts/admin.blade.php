...
<head>
    ...
    <link href="{{ asset('admin_assets/global_assets/css/icons/icomoon/styles.min.css?v='. app()->version()) }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('admin_assets/assets/css/all.min.css?v' . app()->version()) }}" rel="stylesheet" type="text/css">
    <!-- /global stylesheets -->
    ...
    <script src="{{ asset('admin_assets/global_assets/js/demo_charts/pages/dashboard/light/streamgraph.js') }}"></script>
    <script src="{{ asset('admin_assets/global_assets/js/demo_charts/pages/dashboard/light/sparklines.js') }}"></script>
    <script src="{{ asset('admin_assets/global_assets/js/demo_charts/pages/dashboard/light/lines.js') }}"></script>
    <script src="{{ asset('admin_assets/global_assets/js/demo_charts/pages/dashboard/light/areas.js') }}"></script>
    <script src="{{ asset('admin_assets/global_assets/js/demo_charts/pages/dashboard/light/donuts.js') }}"></script>
    <script src="{{ asset('admin_assets/global_assets/js/demo_charts/pages/dashboard/light/bars.js') }}"></script>
    <script src="{{ asset('admin_assets/global_assets/js/demo_charts/pages/dashboard/light/progress.js') }}"></script>
    <script src="{{ asset('admin_assets/global_assets/js/demo_charts/pages/dashboard/light/heatmaps.js') }}"></script>
    <script src="{{ asset('admin_assets/global_assets/js/demo_charts/pages/dashboard/light/pies.js') }}"></script>
    <script src="{{ asset('admin_assets/global_assets/js/demo_charts/pages/dashboard/light/bullets.js') }}"></script>

    @stack('addition-script')
    <!-- /theme JS files -->
...
<div class="navbar navbar-expand-lg navbar-dark navbar-static">
    ...
    <div class="navbar-brand text-center text-lg-left">
        <a href="index.html" class="d-inline-block">
            <img src="{{ asset('admin_assets/global_assets/images/logo_light.png') }}" class="d-none d-sm-block" alt="">
            <img src="{{ asset('admin_assets/global_assets/images/logo_icon_light.png') }}" class="d-sm-none" alt="">
        </a>
    </div>
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-lg-300">
                    ...
                    <div class="dropdown-content-body dropdown-scrollable">
                        <ul class="media-list">
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{ asset('admin_assets/global_assets/images/placeholders/placeholder.jpg') }}" width="36" height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                                ...
                                <div class="ml-3 align-self-center">
                                    <span class="badge badge-mark border-success"></span></div>
                            </li>
                            ...
                            <li class="media">
                                ...
                                <div class="ml-3 align-self-center">
                                    <span class="badge badge-mark border-warning"></span></div>
                            </li>
                            ...
                            <li class="media">
                                ...
                                <div class="ml-3 align-self-center">
                                    <span class="badge badge-mark border-secondary"></span></div>
                            </li>
                        </ul>
                    </div>
    ...
    <ul class="navbar-nav flex-row order-1 order-lg-2 flex-1 flex-lg-0 justify-content-end align-items-center">
        ...
        <li class="nav-item nav-item-dropdown-lg dropdown dropdown-user h-100">
            <a href="#" class="navbar-nav-link navbar-nav-link-toggler dropdown-toggle d-inline-flex align-items-center h-100" data-toggle="dropdown">
                <img src="{{ asset('admin_assets/global_assets/images/placeholders/placeholder.jpg') }}" class="rounded-pill mr-lg-2" height="34" alt="">
        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-section sidebar-user my-1">
                <div class="sidebar-section-body">
                    <div class="media">
                        <a href="#" class="mr-3">
                            <img src="{{ asset('admin_assets/global_assets/images/placeholders/placeholder.jpg') }}" class="rounded-circle" alt="">
                        </a>
            ...
            <div class="sidebar-section">
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item-header">
                        <div class="text-uppercase font-size-xs line-height-xs">Books</div>
                    ...
                    <!-- Categories -->
                    <li class="nav-item-header">
                        <div class="text-uppercase font-size-xs line-height-xs">Категории</div>
                        <i class="icon-menu" title="Forms"></i></li>
                    <li class="nav-item nav-item-submenu">
            ...
            <div class="navbar navbar-expand-lg navbar-light border-bottom-0 border-top">
                ...
                <div class="navbar-collapse collapse" id="navbar-footer">
						<span class="navbar-text">
							&copy; 2021. <a href="#">Book</a> by <a href="#" target="_blank">sheyh2</a>
						</span>
                </div>
            </div>
            <!-- /footer -->
