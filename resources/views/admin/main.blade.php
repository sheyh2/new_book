        ...
        <div class="page-header-content header-elements-lg-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="#" class="btn btn-link btn-float text-body">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('admin_assets/global_assets/images/brands/facebook.svg') }}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('admin_assets/global_assets/images/brands/youtube.svg') }}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('admin_assets/global_assets/images/brands/spotify.svg') }}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('admin_assets/global_assets/images/brands/twitter.svg') }}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('admin_assets/global_assets/images/brands/bing.svg') }}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('admin_assets/global_assets/images/brands/amazon.svg') }}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('admin_assets/global_assets/images/brands/dribbble.svg') }}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mr-3">
                                            <a href="#">
                                                <img src="{{ asset('admin_assets/global_assets/images/placeholders/placeholder.jpg') }}" class="rounded-circle" width="32" height="32" alt="">
                                            </a>
                                        </div>
                                        <div>
                                ...
                                <div class="media flex-column flex-sm-row mt-0 mb-3">
                                    <div class="mr-sm-3 mb-2 mb-sm-0">
                                        <div class="card-img-actions">
                                            <a href="#">
                                                <img src="{{ asset('admin_assets/global_assets/images/placeholders/placeholder.jpg') }}" class="img-fluid img-preview rounded" alt="">
                            ...
                            <ul class="media-list">
                                <li class="media">
                                    <div class="mr-3 position-relative">
                                        <img src="{{ asset('admin_assets/global_assets/images/placeholders/placeholder.jpg') }}" class="rounded-circle" width="36" height="36" alt="">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="media-list">
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <a href="#" class="btn bg-transparent border-warning text-warning rounded-pill border-2 btn-icon"><i class="icon-spinner11"></i></a>
                                </div>
