        ...
        <div class="page-header-content header-elements-lg-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    ...
                    <a href="#" class="btn btn-link btn-float text-body"><i class="icon-calculator text-primary"></i>
                                    ...
                                    <div class="list-icons">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="#" class="dropdown-item"><i class="icon-address-book"></i> Больше</a>
                                                <a href="#" class="dropdown-item bg-primary"><i class="icon-pencil text-white"></i> Изменить</a>
                                                <a href="#" class="dropdown-item bg-danger"><i class="icon-trash"></i> Удалить</a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
